    ...
    inline void blockProc() {
        ...
        for (int i = 0; i < 17; i++) {
            for (int j = 0; j < 8 - 2; j++) {
                ...
                if (cur_color > 0 && matrix.Tiles[i][j + 1] == cur_color && matrix.Tiles[i][j + 2] == cur_color) {
        ...
        for (int z = 0; z < 8; z++) {
            for (int q = 0; q < 17 - 2; q++) {
                ...
                if (cur_color > 0 && matrix.Tiles[q + 1][z] == cur_color && matrix.Tiles[q + 2][z] == cur_color) {
        ...
        for (int p = 0; p < 8; p++) {
            for (int w = 0; w < 17; w++) {
                ...
                if (cur_color > 0) {
                    if (w + 2 < 17 && p + 2 < 8 && matrix.Tiles[w + 1][p + 1] == cur_color && matrix.Tiles[w + 2][p + 2] == cur_color) {
                    ...
                    if (w - 2 >= 0 && p - 2 >= 0 && matrix.Tiles[w - 1][p - 1] == cur_color && matrix.Tiles[w - 2][p - 2] == cur_color) {
                        matrix.Tiles[w][p] = -TileMatrix::FLASH_STEPS;
                        matrix.Tiles[w - 1][p - 1] = -TileMatrix::FLASH_STEPS;
                        matrix.Tiles[w - 2][p - 2] = -TileMatrix::FLASH_STEPS;
                        matrix.Game.addline();
                    ...
                    if (w - 2 >= 0 && p + 2 < 8 && matrix.Tiles[w - 1][p + 1] == cur_color && matrix.Tiles[w - 2][p + 2] == cur_color) {
                        matrix.Tiles[w][p] = -TileMatrix::FLASH_STEPS;
                        matrix.Tiles[w - 1][p + 1] = -TileMatrix::FLASH_STEPS;
                        matrix.Tiles[w - 2][p + 2] = -TileMatrix::FLASH_STEPS;
                        matrix.Game.addline();
                    ...
                    if (w + 2 < 17 && p - 2 >= 0 && matrix.Tiles[w + 1][p - 1] == cur_color && matrix.Tiles[w + 2][p - 2] == cur_color) {
                        matrix.Tiles[w][p] = -TileMatrix::FLASH_STEPS;
                        matrix.Tiles[w + 1][p - 1] = -TileMatrix::FLASH_STEPS;
                        matrix.Tiles[w + 2][p - 2] = -TileMatrix::FLASH_STEPS;
                        matrix.Game.addline();
